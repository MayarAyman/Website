<html>
<head> <title> Shareholders</title> 
<script src="http://code.jquery.com/jquery-1.9.1.js"></script>
<script src="http://code.jquery.com/ui/1.10.1/jquery-ui.js"></script>
<script>
	$( "#egas" ).tooltip({ content: '<img src="EG.jpg">' });
	$( "#apic" ).tooltip({ content: '<img src="API.jpg">' });
	$( "#dana" ).tooltip({ content: '<img src="DANA.jpg">' });
</script>
</head>
<link rel="stylesheet" type="text/css" href="CSS.css" media="all" />
<body>
<div class="l"><a href="Home.php"><img id="clip" src="logo.png"  display: "block" height="50" width="220"></a></div>
<br/>
<br/>
